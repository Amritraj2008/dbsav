...
auth_channel = environ.get('AUTH_CHANNEL', '-1001726816783')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001733097568', '-1001246645273')).split()]

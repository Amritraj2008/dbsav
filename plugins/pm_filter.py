...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('This Movie Not Found In DataBase. Request on @Req1Bot for this movie')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤖 Updates', url='https://t.me/Tech_sav_bots')
        ], [
        ...
        buttons = [[
            ...
            InlineKeyboardButton('♥️ Request a movie', callback_data='request')
        ], [
            InlineKeyboardButton('🏠 Home', callback_data='start'),
